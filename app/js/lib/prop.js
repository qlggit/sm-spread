...
prop(String , 'turnObjectKey' , function(){
  if(this.indexOf('_') > -1){
    return this.split('_').map(function(a , i){
      if(i){
  ...
  return this.replace(/[A-Z]/g , function(a){return '_' + a.toLowerCase()});
});
...
if(!Object.values){
    Object.values = function(data){
      return Object.keys(data).map(function(a){
        return data[a];
      });
    }
}
